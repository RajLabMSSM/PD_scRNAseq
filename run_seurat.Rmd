...
pbmc <- ScaleData(object = pbmc, vars.to.regress = c("nUMI", "percent.mito"), do.par = T, num.cores = par.Cores)
```
...
```{r Defining Cell-types by Markers}
...
```{r Known Biomarkers: tSNE code, echo = T, results = 'hide', fig.show='hide'}
