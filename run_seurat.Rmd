...
params <- list(set_title=paste(sep="", "PDscRNAseq__",
                ...
                ".html"))
customOutput <- paste(sep="", "PDscRNAseq__",
                "Genes-",subsetGenes,"__Cells-",subsetCells,"__Resolution-",resolution,
                ".html")

knitr::opts_chunk$set(echo=T, error=T, cache=T, cache.lazy=F)
knitr::knit_theme$set(knitr::knit_theme$get("bipolar"))
...
```{r percent.mito - process, results=F} 
# par(mfrow = c(1, 2))
...
## Top Biomarkers {.tabset .tabset-fade .tabset-pills}
```{r}
...
# Further subdivisions within cell types {.tabset .tabset-fade .tabset-pills}
