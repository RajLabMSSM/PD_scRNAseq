...
Rstudio has a memory default limit of only 1GB. To override this, detect the true memory available and set a new limit.
...
Control for: number of unique transcripts (nUMI), % mitochondrial transcripts (percent.mito) 
