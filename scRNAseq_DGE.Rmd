...
```{r PD Monocle plot, fig.height=14, fig.width=14} 
plot_cell_clusters(mDAT, markers = c("LRRK2","GBA", overlappingGenes_PD), cell_size = 0.01)
```

```{r PD Full Heatmap, fig.height=14} 
...
```{r AD Monocle plot, fig.height=14, fig.width=14} 
plot_cell_clusters(mDAT, markers = overlappingGenes_AD, cell_size = 0.01)
```

```{r AD Full Heatmap, fig.height=14} 
