...
load(file.path("./Data/seurat_object_add_HTO_ids.Rdata"))
DAT <- seurat.obj  
rm(seurat.obj)
```
...
```{r Within Clusters: cell_type, results='asis'}
...
```{r Save Results}  
save.image(file.path(resultsPath, "scRNAseq_data.RData"))   
```
