...
ggsave(file.path("./Results/Mito_lists_for_the_single_cell_analysis",
                 paste0("curatedModule_exprs.png")), 
       plot=cp, dpi=300, width=10, height=6)  
```
...
## Save
ggsave(file="Results/Mito_lists_for_the_single_cell_analysis/mitochondrial_modules.png", 
...
customModule.cluster <- grouped_module_expression(cds,
                                                 ...
                                                 group_variable="cluster",
                                                 module_variable = "Curated module",
                                                 show_plot=T, 
