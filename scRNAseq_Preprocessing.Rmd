...
TRY do.par=T threads=nCores*2
CRANK UP PERPLEXITY TO 50 (explicit)
...
DAT <- RunTSNE(object=DAT,  reduction.use = "pca", dims.use = 1:10, do.fast = TRUE,
                 tsne.method = "Rtsne", num_threads = nCores, verbose=F, perplexity=perplexity) #   FItSNE 
